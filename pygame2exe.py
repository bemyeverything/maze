...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "the aMAZEing"

        #Project url
        self.project_url = "https://github.com/bemyeverything/maze"
        ...
        #Auhor of program
        self.author_name = "Me"
        self.author_email = "shielafuertes@gmail.com"
        self.copyright = "Copyright (c) 2015."

        #Description
        self.project_description = "A little pygame for little kids. Inspired by the improved version made by Author: yipyip with License: Do What The Fuck You Want To Public License (WTFPL)"
